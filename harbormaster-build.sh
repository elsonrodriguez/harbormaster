...
REPLACE_VARS='$K8S_CLEAN_BUILD:$K8S_VERSION:$K8S_CLUSTER_IP_RANGE:$K8S_NODE_POD_CIDR:$COBBLER_IP:$NETWORK_GATEWAY:$NETWORK_DOMAIN:$NETWORK_BOOTP_START:$NETWORK_BOOTP_END:$NETWORK_NETMASK:$NETWORK_SUBNET:$NETWORK_UPSTREAMDNS:$NETWORK_DNS_REVERSE:$NUM_MASTERS:$NETWORK_NETMASK2:$HTTP_PROXY:$K8S_SKYDNS_CLUSTERIP:$ENABLE_PROXY:$HTTP_PROXY:$HTTPS_PROXY:$SOCKS_PROXY:$NO_PROXY:$FTP_PROXY:$ROOT_DISK_PATH_PATTERN:$NTP_SERVER:$TIMEZONE:$ROOT_DISK_PATH_PATTERN_UBUNTU'
